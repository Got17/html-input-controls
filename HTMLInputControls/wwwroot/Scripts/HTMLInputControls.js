import Runtime, { Start as Start_1 } from "./WebSharper.Core.JavaScript/Runtime.js"
...
function Main(){
  ...
  const t_1=(t.h.push(EventQ2(t.k, "picka", () => t.i, () => {
    radioGroup().Set("A");
  })),t);
  const t_2=(t_1.h.push(EventQ2(t_1.k, "pickb", () => t_1.i, () => {
    radioGroup().Set("B");
  })),t_1);
  const t_3=(t_2.h.push(EventQ2(t_2.k, "pickc", () => t_2.i, () => {
    radioGroup().Set("C");
  })),t_2);
  const b=(t_3.h.push(EventQ2(t_3.k, "submitform", () => t_3.i, (e) => {
    e.Event.preventDefault();
    const v=e.Vars;
    console.log("[Textual]");
    console.log("TextInput:", TemplateHole.Value(v.Hole("textinput")).Get());
    console.log("Textarea:", TemplateHole.Value(v.Hole("textarea")).Get());
    console.log("Password:", TemplateHole.Value(v.Hole("password")).Get());
    console.log("Email:", TemplateHole.Value(v.Hole("email")).Get());
    console.log("Url:", TemplateHole.Value(v.Hole("url")).Get());
    console.log("Tel:", TemplateHole.Value(v.Hole("tel")).Get());
    console.log("Search:", TemplateHole.Value(v.Hole("search")).Get());
    console.log("[Numbers & Ranges]");
    console.log("Number:", TemplateHole.Value(v.Hole("number")).Get());
    console.log("Range:", TemplateHole.Value(v.Hole("range")).Get());
    console.log("[Dates & Times]");
    console.log("Date:", TemplateHole.Value(v.Hole("date")).Get());
    console.log("Time:", TemplateHole.Value(v.Hole("time")).Get());
    console.log("DatetimeLocal:", TemplateHole.Value(v.Hole("datetimelocal")).Get());
    console.log("Month:", TemplateHole.Value(v.Hole("month")).Get());
    console.log("Week:", TemplateHole.Value(v.Hole("week")).Get());
    console.log("[Choices]");
    console.log("SelectSingle:", TemplateHole.Value(v.Hole("selectsingle")).Get());
    console.log("SelectMulti:", concat(", ", TemplateHole.Value(v.Hole("selectmulti")).Get()));
    console.log("RadioGroup:", radioGroup().Get());
    console.log("Chk1:", TemplateHole.Value(v.Hole("chk1")).Get());
    console.log("Chk2:", TemplateHole.Value(v.Hole("chk2")).Get());
    console.log("DatalistInput:", TemplateHole.Value(v.Hole("datalistinput")).Get());
    console.log("Color:", TemplateHole.Value(v.Hole("color")).Get());
  })),t_3);
  const p=CompleteHoles(b.k, b.h, [["textinput", 0, null], ["textarea", 0, null], ["password", 0, null], ["email", 0, null], ["url", 0, null], ["tel", 0, null], ["search", 0, null], ["number", 1, Some(10)], ["range", 1, Some(25)], ["date", 0, null], ["time", 0, null], ["datetimelocal", 3, null], ["month", 0, null], ["week", 0, null], ["selectsingle", 0, null], ["selectmulti", 6, null], ["chk1", 2, null], ["chk2", 2, Some(true)], ["datalistinput", 0, null], ["color", 0, Some("#4f46e5")]]);
        ...
        if(value[1].$1.$==1){
          if(value[1].$1.$1.$==1){
            if(value[1].$1.$1.$1.$==0){
              ...
              const s_2=value[0];
              _9=Dynamic_1(attrName, Map_1((vs) => s_2+concat("", vs), Sequence_1(value[1])));
            }
          }
          else {
            const s_3=value[0];
